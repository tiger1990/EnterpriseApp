...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxBaselineLibraryAccessors laccForAndroidxBaselineLibraryAccessors = new AndroidxBaselineLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.baseline</b>
         */
        public AndroidxBaselineLibraryAccessors getBaseline() {
            return laccForAndroidxBaselineLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>androidx.savedstate</b>
         */
        public AndroidxSavedstateLibraryAccessors getSavedstate() {
            return laccForAndroidxSavedstateLibraryAccessors;
        }
    ...
    public static class AndroidxBaselineLibraryAccessors extends SubDependencyFactory {

        public AndroidxBaselineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>profile</b> with <b>androidx.benchmark:benchmark-macro-junit4</b> coordinates and
         * with version reference <b>macrobenchmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getProfile() {
            return create("androidx.baseline.profile");
        }
    ...
    public static class AndroidxSavedstateLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.savedstate:savedstate-ktx</b> coordinates and
         * with version reference <b>savedstate</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("androidx.savedstate.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>baselineProfile</b> with value <b>1.5.0-alpha03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeAnimation</b> with value <b>1.10.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hilt</b> with value <b>2.59.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltExt</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltNavigationCompose</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlin</b> with value <b>2.3.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinSerialization</b> with value <b>1.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>macrobenchmark</b> with value <b>1.5.0-alpha03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockk</b> with value <b>1.14.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationCompose</b> with value <b>2.9.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>paparazzi</b> with value <b>1.3.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.baselineprofile</b> with value <b>1.3.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final BaselinePluginAccessors paccForBaselinePluginAccessors = new BaselinePluginAccessors(providers, config);
        private final ComposePluginAccessors paccForComposePluginAccessors = new ComposePluginAccessors(providers, config);
        private final EnterprisePluginAccessors paccForEnterprisePluginAccessors = new EnterprisePluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.baseline</b>
         */
        public BaselinePluginAccessors getBaseline() {
            return paccForBaselinePluginAccessors;
        }
        ...
        /**
         * Group of plugins at <b>plugins.enterprise</b>
         */
        public EnterprisePluginAccessors getEnterprise() {
            return paccForEnterprisePluginAccessors;
        }
    ...
    public static class BaselinePluginAccessors extends PluginFactory {

        public BaselinePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>baseline.profile</b> with plugin id <b>androidx.baselineprofile</b> and
         * with version reference <b>baselineProfile</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getProfile() { return createPlugin("baseline.profile"); }
    ...
    public static class EnterprisePluginAccessors extends PluginFactory {
        private final EnterpriseAndroidPluginAccessors paccForEnterpriseAndroidPluginAccessors = new EnterpriseAndroidPluginAccessors(providers, config);

        public EnterprisePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.enterprise.android</b>
         */
        public EnterpriseAndroidPluginAccessors getAndroid() {
            return paccForEnterpriseAndroidPluginAccessors;
        }

    }

    public static class EnterpriseAndroidPluginAccessors extends PluginFactory {
        private final EnterpriseAndroidApplicationPluginAccessors paccForEnterpriseAndroidApplicationPluginAccessors = new EnterpriseAndroidApplicationPluginAccessors(providers, config);
        private final EnterpriseAndroidLibraryPluginAccessors paccForEnterpriseAndroidLibraryPluginAccessors = new EnterpriseAndroidLibraryPluginAccessors(providers, config);

        public EnterpriseAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>enterprise.android.feature</b> with plugin id <b>enterprise.android.feature</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getFeature() { return createPlugin("enterprise.android.feature"); }

        /**
         * Plugin provider for <b>enterprise.android.hilt</b> with plugin id <b>enterprise.android.hilt</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("enterprise.android.hilt"); }

        /**
         * Group of plugins at <b>plugins.enterprise.android.application</b>
         */
        public EnterpriseAndroidApplicationPluginAccessors getApplication() {
            return paccForEnterpriseAndroidApplicationPluginAccessors;
        }

        /**
         * Group of plugins at <b>plugins.enterprise.android.library</b>
         */
        public EnterpriseAndroidLibraryPluginAccessors getLibrary() {
            return paccForEnterpriseAndroidLibraryPluginAccessors;
        }

    }

    public static class EnterpriseAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public EnterpriseAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>enterprise.android.application</b> with plugin id <b>enterprise.android.application</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("enterprise.android.application"); }

        /**
         * Plugin provider for <b>enterprise.android.application.baselineprofile</b> with plugin id <b>enterprise.android.application.baselineprofile</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getBaselineprofile() { return createPlugin("enterprise.android.application.baselineprofile"); }

        /**
         * Plugin provider for <b>enterprise.android.application.compose</b> with plugin id <b>enterprise.android.application.compose</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("enterprise.android.application.compose"); }

    }

    public static class EnterpriseAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public EnterpriseAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>enterprise.android.library</b> with plugin id <b>enterprise.android.library</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("enterprise.android.library"); }

        /**
         * Plugin provider for <b>enterprise.android.library.compose</b> with plugin id <b>enterprise.android.library.compose</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("enterprise.android.library.compose"); }
